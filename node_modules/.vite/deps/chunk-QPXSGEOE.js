...
function getPopoverMiddlewares(options, getFloating) {
  ...
  if ((_a = options.middlewares) == null ? void 0 : _a.shift) {
    middlewares.push(shift3({ limiter: limitShift3() }));
  }
...
var CloseIcon = (0, import_react87.forwardRef)(
  ({ size: size4 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => import_react87.default.createElement(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var varsResolver21 = createVarsResolver((_, { size: size4 }) => ({
  chevron: {
...
var ComboboxChevron = factory((_props, ref) => {
  ...
  const { size: size4, error, style, className, classNames, styles, unstyled, vars, ...others } = props;
  const getStyles2 = useStyles({
...
var ComboboxClearButton = (0, import_react146.forwardRef)(
  ({ size: size4, onMouseDown, onClick, onClear, ...others }, ref) => import_react146.default.createElement(
    CloseButton,
    {
      ref,
      size: size4 || "sm",
...
var varsResolver22 = createVarsResolver((_, { size: size4, dropdownPadding }) => ({
  options: {
...
var InlineInput = (0, import_react161.forwardRef)(
  ({
    ...
    return import_react161.default.createElement(
      ...
      import_react161.default.createElement("div", { ...getStyles2("body") }, children, import_react161.default.createElement("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0 }, label && import_react161.default.createElement("label", { ...getStyles2("label"), "data-disabled": disabled || void 0, htmlFor: id }, label), description && import_react161.default.createElement(Input.Description, { size: size4, __inheritStyles: false, ...getStyles2("description") }, description), error && error !== "boolean" && import_react161.default.createElement(Input.Error, { size: size4, __inheritStyles: false, ...getStyles2("error") }, error)))
    );
  }
);
...
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, ...others } = useProps(
    "CheckboxGroup",
    defaultProps54,
    props
  );
  ...
  return import_react164.default.createElement(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 } }, import_react164.default.createElement(
    Input.Wrapper,
    {
      size: size4,
      ref,
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  const { classNames, className, style, styles, unstyled, vars, inline: inline4, ...others } = props;
  const getStyles2 = useStyles({
    name: "Center",
    props,
    classes: classes32,
  ...
  return import_react183.default.createElement(Box, { ref, mod: { inline: inline4 }, ...getStyles2("root"), ...others });
});
...
var ColorSlider = factory((_props, ref) => {
  ...
  return import_react191.default.createElement(
    Box,
    {
      ...
      __vars: {
        "--_cp-thumb-size": `var(--cp-thumb-size-${size4})`
      }
    },
    layers,
...
var varsResolver38 = createVarsResolver((_, { size: size4, swatchesPerRow }) => ({
  wrapper: {
...
var varsResolver39 = createVarsResolver((_, { size: size4 }) => ({
  eyeDropperIcon: {
...
// node_modules/@mantine/core/esm/components/Container/Container.mjs
var defaultProps77 = {};
var varsResolver40 = createVarsResolver((_, { size: size4, fluid }) => ({
  root: {
...
var varsResolver42 = createVarsResolver((theme, { color, variant, size: size4 }) => ({
  root: {
...
var varsResolver43 = createVarsResolver((_, { position, size: size4, offset: offset4 }) => ({
  root: {
...
var Indicator = factory((_props, ref) => {
  ...
  return import_react232.default.createElement(Box, { ref, ...getStyles2("root"), mod: { inline: inline4 }, ...others }, !disabled && import_react232.default.createElement(import_react232.default.Fragment, null, import_react232.default.createElement(
    Box,
    {
...
var useLatest = function useLatest2(value) {
  var ref = import_react234.default.useRef(value);
  index3(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react235.default.useRef();
  return import_react235.default.useCallback(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react237.useState)(validateJson(_value, deserialize));
...
// node_modules/@mantine/core/esm/components/Kbd/Kbd.mjs
var defaultProps103 = {};
var varsResolver49 = createVarsResolver((_, { size: size4 }) => ({
  root: {
...
var Kbd = factory((_props, ref) => {
  ...
  return import_react238.default.createElement(Box, { component: "kbd", ref, ...getStyles2("root"), ...others });
});
...
var ListItem = factory((_props, ref) => {
  ...
  return import_react240.default.createElement(
    ...
    import_react240.default.createElement("div", { ...ctx.getStyles("itemWrapper", stylesApiProps) }, _icon && import_react240.default.createElement("span", { ...ctx.getStyles("itemIcon", stylesApiProps) }, _icon), import_react240.default.createElement("span", { ...ctx.getStyles("itemLabel", stylesApiProps) }, children))
  );
});
...
var varsResolver50 = createVarsResolver((_, { size: size4, spacing }) => ({
  root: {
...
var List = factory((_props, ref) => {
  ...
  return import_react241.default.createElement(ListProvider, { value: { center, icon, getStyles: getStyles2 } }, import_react241.default.createElement(
    Box,
    {
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return import_react242.default.createElement(Transition, { transition: "fade", ...transitionProps, mounted: !!visible }, (transitionStyles) => import_react242.default.createElement(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others }, import_react242.default.createElement(Loader, { ...getStyles2("loader"), unstyled, ...loaderProps }), import_react242.default.createElement(
    Overlay,
    {
      ..._overlayProps,
      ...getStyles2("overlay"),
  ...
  ), import_react242.default.createElement(
    Overlay,
    {
      ..._overlayProps,
      ...getStyles2("overlay"),
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react245.useRef)(null);
  const ctx = useMenuContext();
  const handleKeyDown = (event) => {
    var _a, _b;
  ...
  return import_react245.default.createElement(
    ...
    import_react245.default.createElement("div", { tabIndex: -1, "data-autofocus": true }),
    children
  );
});
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react246.useRef)();
  ...
  return import_react246.default.createElement(
    ...
    leftSection && import_react246.default.createElement("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left" }, leftSection),
    children && import_react246.default.createElement("div", { ...ctx.getStyles("itemLabel", { styles, classNames }) }, children),
    rightSection && import_react246.default.createElement("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right" }, rightSection)
  );
});
...
var MenuTarget = (0, import_react248.forwardRef)((props, ref) => {
  ...
  return import_react248.default.createElement(Popover.Target, { refProp, popupType: "menu", ref, ...others }, (0, import_react248.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react249.useState)(false);
  const close = () => {
    setOpened(false);
...
var ModalContent = factory((_props, ref) => {
  ...
  return import_react254.default.createElement(
    ...
    import_react254.default.createElement(Scroll, { style: { maxHeight: `calc(100vh - (${rem(ctx.yOffset)} * 2))` } }, children)
  );
});
...
var ModalRoot = factory((_props, ref) => {
  ...
  return import_react257.default.createElement(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2 } }, import_react257.default.createElement(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
var Modal = factory((_props, ref) => {
  ...
  const hasHeader = !!title || withCloseButton;
  return import_react259.default.createElement(ModalRoot, { ref, radius, ...others }, withOverlay && import_react259.default.createElement(ModalOverlay, { ...overlayProps }), import_react259.default.createElement(ModalContent, { radius }, hasHeader && import_react259.default.createElement(ModalHeader, null, title && import_react259.default.createElement(ModalTitle, null, title), withCloseButton && import_react259.default.createElement(ModalCloseButton, { ...closeButtonProps })), import_react259.default.createElement(ModalBody, null, children)));
});
...
// node_modules/@mantine/core/esm/components/Pill/PillGroup/PillGroup.mjs
var defaultProps121 = {};
var varsResolver53 = createVarsResolver((_, { gap }, { size: size4 }) => ({
  group: {
...
var PillGroup = factory((_props, ref) => {
  ...
  return import_react262.default.createElement(PillGroupProvider, { value: { size: _size, disabled } }, import_react262.default.createElement(Box, { ref, size: _size, ...getStyles2("group"), ...others }));
});
...
var varsResolver54 = createVarsResolver((_, { radius }, { size: size4 }) => ({
  root: {
...
var Pill = factory((_props, ref) => {
  ...
  return import_react263.default.createElement(
    ...
    import_react263.default.createElement("span", { ...getStyles2("label") }, children),
    withRemoveButton && import_react263.default.createElement(
      CloseButton,
      {
        variant: "transparent",
        radius,
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react265.useRef)();
  return import_react265.default.createElement(PillsInputProvider, { value: { fieldRef, size: size4, disabled, hasError: !!error, variant } }, import_react265.default.createElement(
    InputBase,
    {
      size: size4,
      error,
...
var MultiSelect = factory((_props, ref) => {
  ...
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && import_react267.default.createElement(
  ...
  return import_react267.default.createElement(import_react267.default.Fragment, null, import_react267.default.createElement(
    Combobox,
    {
      store: combobox,
      classNames: resolvedClassNames,
    ...
    import_react267.default.createElement(Combobox.DropdownTarget, null, import_react267.default.createElement(
      PillsInput,
      {
        ...styleProps,
        __staticSelector: "MultiSelect",
        ...
        disabled,
        radius,
        rightSection: rightSection || clearButton || import_react267.default.createElement(Combobox.Chevron, { size: size4, error, unstyled }),
      ...
      import_react267.default.createElement(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList") }, values2, import_react267.default.createElement(Combobox.EventsTarget, null, import_react267.default.createElement(
        PillsInput.Field,
        {
          ...rest,
          ref,
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => import_react268.default.createElement(NativeSelectOption, { key: item.value, data: item }));
    return import_react268.default.createElement("optgroup", { label: data.group }, items);
  }
  const { value, label, ...others } = data;
  return import_react268.default.createElement("option", { key: data.value, value: data.value, ...others }, data.label);
}
...
var NativeSelect = factory((props, ref) => {
  const { data, children, size: size4, error, rightSection, unstyled, ...others } = useProps(
    "NativeSelect",
    defaultProps126,
    props
  );
  const options = getParsedComboboxData(data).map((item, index5) => import_react269.default.createElement(NativeSelectOption, { key: index5, data: item }));
  return import_react269.default.createElement(
    InputBase,
    {
      ...
      error,
      unstyled,
      rightSection: rightSection || import_react269.default.createElement(ComboboxChevron, { size: size4, error, unstyled })
    },
    children || options
  );
});
...
var NavLink = polymorphicFactory((_props, ref) => {
  ...
  return import_react270.default.createElement(import_react270.default.Fragment, null, import_react270.default.createElement(
    ...
    leftSection && import_react270.default.createElement(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" } }, leftSection),
    import_react270.default.createElement(Box, { ...getStyles2("body"), mod: { "no-wrap": noWrap } }, import_react270.default.createElement(Box, { component: "span", ...getStyles2("label") }, label), import_react270.default.createElement(Box, { component: "span", mod: { active }, ...getStyles2("description") }, description)),
    (withChildren || rightSection) && import_react270.default.createElement(
      Box,
      {
        ...getStyles2("section"),
        component: "span",
      ...
      withChildren ? rightSection || import_react270.default.createElement(AccordionChevron, { ...getStyles2("chevron") }) : rightSection
    )
  ), import_react270.default.createElement(Collapse, { in: _opened }, import_react270.default.createElement("div", { ...getStyles2("children") }, children)));
});
...
var Notification = factory((_props, ref) => {
  ...
  return import_react271.default.createElement(
    ...
    icon && !loading && import_react271.default.createElement("div", { ...getStyles2("icon") }, icon),
    loading && import_react271.default.createElement(Loader, { size: 28, color, ...getStyles2("loader") }),
    import_react271.default.createElement("div", { ...getStyles2("body") }, title && import_react271.default.createElement("div", { ...getStyles2("title") }, title), import_react271.default.createElement(Box, { ...getStyles2("description"), mod: { "data-with-title": !!title } }, children)),
    withCloseButton && import_react271.default.createElement(
      CloseButton,
      {
        iconSize: 16,
        color: "gray",
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react272.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react272.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--)
      args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react272.useState)(function() {
  ...
  (0, import_react272.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react272.useRef)();
  var lastUpdatedValue = (0, import_react272.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react272.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react272.useRef)(null);
  var timeout = (0, import_react272.useRef)({
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react272.useLayoutEffect : import_react272.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react272.default.createElement(import_react272.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react272.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react272.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react272.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react272.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
function NumberFormatter(_props) {
  ...
  return import_react273.default.createElement(NumericFormat, { displayType: "text", value, ...others });
}
...
var varsResolver57 = createVarsResolver((_, { size: size4 }) => ({
  controls: {
...
var NumberInput = factory((_props, ref) => {
  ...
  const onStepTimeoutRef = (0, import_react275.useRef)(null);
  const stepCountRef = (0, import_react275.useRef)(0);
  ...
  const incrementRef = (0, import_react275.useRef)();
  ...
  const decrementRef = (0, import_react275.useRef)();
  ...
  const controls = import_react275.default.createElement("div", { ...getStyles2("controls") }, import_react275.default.createElement(
    UnstyledButton,
    {
      ...getStyles2("control"),
      tabIndex: -1,
    ...
    import_react275.default.createElement(NumberInputChevron, { direction: "up" })
    ...
    import_react275.default.createElement(NumberInputChevron, { direction: "down" })
  ));
...
var PaginationRoot = factory((_props, ref) => {
  ...
  return import_react282.default.createElement(
    ...
    import_react282.default.createElement(Box, { ref, ...getStyles2("root"), ...others })
  );
});
...
var Pagination = factory((_props, ref) => {
  ...
  return import_react283.default.createElement(PaginationRoot, { ref, total, ...others }, import_react283.default.createElement(Group, { gap }, withEdges && import_react283.default.createElement(PaginationFirst, { icon: firstIcon, ...getControlProps == null ? void 0 : getControlProps("first") }), withControls && import_react283.default.createElement(PaginationPrevious, { icon: previousIcon, ...getControlProps == null ? void 0 : getControlProps("previous") }), import_react283.default.createElement(PaginationItems, { dotsIcon }), withControls && import_react283.default.createElement(PaginationNext, { icon: nextIcon, ...getControlProps == null ? void 0 : getControlProps("next") }), withEdges && import_react283.default.createElement(PaginationLast, { icon: lastIcon, ...getControlProps == null ? void 0 : getControlProps("last") })));
});
...
var PasswordInput = factory((_props, ref) => {
  ...
  const visibilityToggleButton = import_react285.default.createElement(
    ActionIcon,
    {
    ...
    import_react285.default.createElement(VisibilityToggleIcon, { reveal: _visible })
  );
...
var varsResolver60 = createVarsResolver((_, { size: size4 }) => ({
  root: {
    "--pin-input-size": getSize(size4 ?? defaultProps136.size, "pin-input-size")
  }
}));
var PinInput = factory((props, ref) => {
  ...
  return import_react286.default.createElement(import_react286.default.Fragment, null, import_react286.default.createElement(
    Group,
    {
      ...others,
      ...getStyles2("root"),
    ...
    createPinArray(length ?? 0, _value).map((char, index5) => import_react286.default.createElement(
      Input,
      {
        component: "input",
        ...getStyles2("pinInput", {
  ...
  ), import_react286.default.createElement("input", { type: "hidden", name, form, value: _value, ...hiddenInputProps }));
});
...
var defaultProps138 = {};
var varsResolver61 = createVarsResolver((_, { size: size4, radius }) => ({
  root: {
...
var ProgressRoot = factory((_props, ref) => {
  ...
  return import_react289.default.createElement(ProgressProvider, { value: { getStyles: getStyles2, autoContrast } }, import_react289.default.createElement(Box, { ref, ...getStyles2("root"), ...others }));
});
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, name, ...others } = useProps(
    "RadioGroup",
    defaultProps141,
    props
  );
  ...
  return import_react293.default.createElement(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size4, name: _name } }, import_react293.default.createElement(
    Input.Wrapper,
    {
      size: size4,
      ref,
...
function RadioIcon({ size: size4, style, ...others }) {
  return import_react294.default.createElement(
    ...
    import_react294.default.createElement("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
  );
}
...
var Radio = factory((_props, ref) => {
  ...
  return import_react295.default.createElement(
    ...
    import_react295.default.createElement(Box, { ...getStyles2("inner"), mod: { "label-position": labelPosition } }, import_react295.default.createElement(
      Box,
      {
    ...
    ), import_react295.default.createElement(Icon, { ...getStyles2("icon"), "aria-hidden": true }))
  );
});
...
function StarIcon(props) {
  ...
  return import_react297.default.createElement(
    ...
    import_react297.default.createElement("path", { d: "M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" })
  );
}
...
function StarSymbol({ type }) {
  ...
  return import_react298.default.createElement(StarIcon, { ...ctx.getStyles("starSymbol"), "data-filled": type === "full" || void 0 });
}
...
function RatingItem({
  ...
  const { dir } = useDirection();
  return import_react299.default.createElement(import_react299.default.Fragment, null, !readOnly && import_react299.default.createElement(
    "input",
    {
      ...ctx.getStyles("input"),
  ...
  ), import_react299.default.createElement(
    Box,
    {
    ...
    import_react299.default.createElement(
      ...
      full ? _fullIcon || import_react299.default.createElement(StarSymbol, { type: "full" }) : _emptyIcon || import_react299.default.createElement(StarSymbol, { type: "empty" })
    )
  ));
}
...
var varsResolver63 = createVarsResolver((theme, { size: size4, color }) => ({
  root: {
...
var Rating = factory((_props, ref) => {
  ...
  const _name = useId(name);
  const _id = useId(id);
  const rootRef = (0, import_react300.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: 0,
  ...
  const [hovered, setHovered] = (0, import_react300.useState)(-1);
  const [isOutside, setOutside] = (0, import_react300.useState)(true);
  ...
  return import_react300.default.createElement(RatingProvider, { value: { getStyles: getStyles2 } }, import_react300.default.createElement(
    Box,
    {
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react301.useState)(false);
  const boundaryRef = (0, import_react301.useRef)();
  ...
  const handleMouseMove = (0, import_react301.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return import_react303.default.createElement(import_react303.default.Fragment, null, import_react303.default.createElement(OptionalPortal, { ...portalProps, withinPortal }, import_react303.default.createElement(
    Box,
    {
      ...others,
      ...getStyles2("tooltip", {
    ...
    label
  )), (0, import_react303.cloneElement)(children, {
    ...children.props,
    [refProp]: targetRef,
    onMouseEnter,
    onMouseLeave
...
var TooltipGroupContext = (0, import_react304.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react304.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  ...
  return import_react305.default.createElement(TooltipGroupProvider, { value: true }, import_react305.default.createElement(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay } }, children));
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react307.useState)(false);
...
var Tooltip = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react309.useRef)(null);
  ...
  return import_react309.default.createElement(import_react309.default.Fragment, null, import_react309.default.createElement(OptionalPortal, { ...portalProps, withinPortal }, import_react309.default.createElement(
    Transition,
    {
      ...transition,
      keepMounted,
    ...
    (transitionStyles) => import_react309.default.createElement(
      Box,
      {
        ...others,
        variant,
  ...
  )), (0, import_react309.cloneElement)(
    children,
...
function Curve({
  ...
  const theme = useMantineTheme();
  return import_react311.default.createElement(Tooltip.Floating, { disabled: !tooltip, label: tooltip }, import_react311.default.createElement(
    Box,
    {
      component: "circle",
      ...others,
...
var varsResolver66 = createVarsResolver((_, { size: size4, thickness }) => ({
  root: {
    "--rp-size": rem(size4),
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset4 }, index5) => import_react312.default.createElement(
    Curve,
    {
      ...data,
      key: index5,
  ...
  return import_react312.default.createElement(Box, { ...getStyles2("root"), size: size4, ref, ...others }, import_react312.default.createElement("svg", { ...getStyles2("svg") }, curves), label && import_react312.default.createElement("div", { ...getStyles2("label") }, label));
});
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [activePosition, setActivePosition] = (0, import_react313.useState)({
    width: 0,
    height: 0,
    translate: [0, 0]
  });
  const uuid = useId(name);
  const refs = (0, import_react313.useRef)({});
  const rootRef = (0, import_react313.useRef)(null);
  const [initialized, setInitialized] = (0, import_react313.useState)(false);
  ...
  const controls = _data.map((item) => import_react313.default.createElement(
    Box,
    {
      ...getStyles2("control"),
  ...
  return import_react313.default.createElement(
    ...
    typeof _value === "string" && import_react313.default.createElement(
      Box,
      {
        component: "span",
        ...getStyles2("indicator"),
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react314.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react314.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
  ...
  const clearButton = clearable && !!_value && !disabled && !readOnly && import_react314.default.createElement(
    Combobox.ClearButton,
    {
      size: size4,
      ...clearButtonProps,
  ...
  return import_react314.default.createElement(import_react314.default.Fragment, null, import_react314.default.createElement(
    Combobox,
    {
      store: combobox,
    ...
    import_react314.default.createElement(Combobox.Target, { targetType: searchable ? "input" : "button" }, import_react314.default.createElement(
      InputBase,
      {
        id: _id,
        ref,
        rightSection: rightSection || clearButton || import_react314.default.createElement(Combobox.Chevron, { size: size4, error, unstyled }),
        rightSectionPointerEvents: rightSectionPointerEvents || (clearButton ? "all" : "none"),
        ...others,
        size: size4,
        __staticSelector: "Select",
...
function SimpleGridVariables({
  ...
  return import_react315.default.createElement(InlineStyles, { styles: baseStyles, media, selector });
}
...
var SimpleGrid = factory((_props, ref) => {
  ...
  const responsiveClassName = useRandomClassName();
  return import_react316.default.createElement(import_react316.default.Fragment, null, import_react316.default.createElement(SimpleGridVariables, { ...props, selector: `.${responsiveClassName}` }), import_react316.default.createElement(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others }));
});
...
var Skeleton = factory((_props, ref) => {
  ...
  return import_react317.default.createElement(Box, { ref, ...getStyles2("root"), mod: { visible, animate }, ...others });
});
  ...
  ({
    ...
    return import_react320.default.createElement(
      ...
      import_react320.default.createElement(
        ...
        (transitionStyles) => import_react320.default.createElement("div", { ...getStyles2("label", { style: transitionStyles }) }, label)
      )
    );
  }
);
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset4, inverted }) {
  ...
  const items = marks.map((mark, index5) => import_react321.default.createElement(
    Box,
    {
    ...
    mark.label && import_react321.default.createElement("div", { ...getStyles2("markLabel") }, mark.label)
  ));
  return import_react321.default.createElement("div", null, items);
}
...
function Track({
  ...
  const { getStyles: getStyles2 } = useSliderContext();
  return import_react322.default.createElement(import_react322.default.Fragment, null, import_react322.default.createElement(Box, { ...getStyles2("trackContainer"), mod: { disabled }, ...containerProps }, import_react322.default.createElement(Box, { ...getStyles2("track"), mod: { inverted, disabled } }, import_react322.default.createElement(
    Box,
    {
  ...
  ), children, import_react322.default.createElement(Marks, { ...others, offset: marksOffset, disabled, inverted }))));
}
...
var Slider = factory((_props, ref) => {
  ...
  return import_react323.default.createElement(SliderProvider, { value: { getStyles: getStyles2 } }, import_react323.default.createElement(
    SliderRoot,
    {
      ...others,
    ...
    import_react323.default.createElement("input", { type: "hidden", name, value: scaledValue, ...hiddenInputProps })
  ));
});
...
var RangeSlider = factory((_props, ref) => {
  ...
  return import_react324.default.createElement(SliderProvider, { value: { getStyles: getStyles2 } }, import_react324.default.createElement(SliderRoot, { ...others, size: size4, ref, disabled }, import_react324.default.createElement(
    Track,
    {
      offset: positions[0],
  ...
  ), import_react324.default.createElement("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }), import_react324.default.createElement("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })));
});
...
var Space = factory((props, ref) => {
  ...
  return import_react325.default.createElement(Box, { ref, ...others, w, miw: miw ?? w, h, mih: mih ?? h });
});
...
var Spoiler = factory((_props, ref) => {
  ...
  const [show, setShowState] = (0, import_react326.useState)(initialState);
  ...
  return import_react326.default.createElement(
    ...
    spoiler && import_react326.default.createElement(
      Anchor,
      {
        component: "button",
        type: "button",
    ...
    import_react326.default.createElement(
      ...
      import_react326.default.createElement("div", { ref: contentRef }, children)
    )
  );
});
...
var Stack = factory((_props, ref) => {
  ...
  return import_react327.default.createElement(Box, { ref, ...getStyles2("root"), variant, ...others });
});
...
var getStepFragment = (Fragment5, step) => {
  if (typeof Fragment5 === "function") {
    return import_react329.default.createElement(Fragment5, { step: step || 0 });
  }
  return Fragment5;
};
var defaultProps157 = {
...
var StepperStep = factory((props, ref) => {
  ...
  return import_react329.default.createElement(
    ...
    withIcon && import_react329.default.createElement("span", { ...ctx.getStyles("stepWrapper", stylesApi) }, import_react329.default.createElement("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes }, import_react329.default.createElement(Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200 }, (transitionStyles) => import_react329.default.createElement(
      "span",
      {
        ...ctx.getStyles("stepCompletedIcon", { style: transitionStyles, ...stylesApi })
      },
      loading ? import_react329.default.createElement(
        Loader,
        {
          color: "var(--mantine-color-white)",
      ...
      ) : getStepFragment(completedIcon, step) || import_react329.default.createElement(CheckIcon, { size: "60%" })
    )), state !== "stepCompleted" ? loading ? import_react329.default.createElement(
      Loader,
      {
        ...ctx.getStyles("stepLoader", stylesApi),
        size: "calc(var(--stepper-icon-size) / 2)",
    ...
    ) : getStepFragment(_icon || icon, step) : null), orientation === "vertical" && import_react329.default.createElement(
      "span",
      {
    ...
    (label || description) && import_react329.default.createElement(
      "span",
      {
      ...
      label && import_react329.default.createElement("span", { ...ctx.getStyles("stepLabel", stylesApi) }, getStepFragment(label, step)),
      description && import_react329.default.createElement("span", { ...ctx.getStyles("stepDescription", stylesApi) }, getStepFragment(description, step))
    )
  );
});
...
var Stepper = factory((_props, ref) => {
  ...
  return import_react330.default.createElement(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition } }, import_react330.default.createElement(Box, { ...getStyles2("root"), ref, size: size4, ...others }, import_react330.default.createElement(
    Box,
    {
      ...getStyles2("steps"),
      mod: {
    ...
    items
  ), content && import_react330.default.createElement("div", { ...getStyles2("content") }, content)));
});
...
var SwitchGroup = factory((props, ref) => {
  ...
  return import_react332.default.createElement(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 } }, import_react332.default.createElement(
    Input.Wrapper,
    {
      size: size4,
      ref,
    ...
    import_react332.default.createElement(InputsGroupFieldset, { role: "group" }, children)
  ));
});
...
var varsResolver74 = createVarsResolver((theme, { radius, color, size: size4 }) => ({
  root: {
...
var Switch = factory((_props, ref) => {
  ...
  return import_react333.default.createElement(
    ...
    import_react333.default.createElement(
      ...
      import_react333.default.createElement(Box, { component: "span", mod: "reduce-motion", ...getStyles2("thumb") }, thumbIcon),
      import_react333.default.createElement("span", { ...getStyles2("trackLabel") }, _checked ? onLabel : offLabel)
    )
  );
});
...
function TableDataRenderer({ data }) {
  return import_react336.default.createElement(import_react336.default.Fragment, null, data.caption && import_react336.default.createElement(TableCaption, null, data.caption), data.head && import_react336.default.createElement(TableThead, null, import_react336.default.createElement(TableTr, null, data.head.map((item, index5) => import_react336.default.createElement(TableTh, { key: index5 }, item)))), data.body && import_react336.default.createElement(TableTbody, null, data.body.map((row, rowIndex) => import_react336.default.createElement(TableTr, { key: rowIndex }, row.map((item, index5) => import_react336.default.createElement(TableTd, { key: index5 }, item))))), data.foot && import_react336.default.createElement(TableTfoot, null, import_react336.default.createElement(TableTr, null, data.foot.map((item, index5) => import_react336.default.createElement(TableTh, { key: index5 }, item)))));
}
...
var TableScrollContainer = factory((_props, ref) => {
  ...
  return import_react337.default.createElement(
    ...
    import_react337.default.createElement("div", { ...getStyles2("scrollContainerInner") }, children)
  );
});
...
var Table = factory((_props, ref) => {
  ...
  return import_react338.default.createElement(
    ...
    import_react338.default.createElement(
      ...
      children || !!data && import_react338.default.createElement(TableDataRenderer, { data })
    )
  );
});
...
var TabsTab = factory((_props, ref) => {
  ...
  return import_react342.default.createElement(
    ...
    leftSection && import_react342.default.createElement("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "left" }, leftSection),
    children && import_react342.default.createElement("span", { ...ctx.getStyles("tabLabel", stylesApiProps) }, children),
    rightSection && import_react342.default.createElement("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "right" }, rightSection)
  );
});
...
var TagsInput = factory((_props, ref) => {
  ...
  const values2 = _value.map((item, index5) => import_react345.default.createElement(
    Pill,
    {
      key: `${item}-${index5}`,
      withRemoveButton: !readOnly,
  ...
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && import_react345.default.createElement(
    Combobox.ClearButton,
    {
      size: size4,
      ...clearButtonProps,
  ...
  return import_react345.default.createElement(import_react345.default.Fragment, null, import_react345.default.createElement(
    Combobox,
    {
      store: combobox,
      classNames: resolvedClassNames,
    ...
    import_react345.default.createElement(Combobox.DropdownTarget, null, import_react345.default.createElement(
      PillsInput,
      {
        ...styleProps,
        __staticSelector: "TagsInput",
      ...
      import_react345.default.createElement(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList") }, values2, import_react345.default.createElement(Combobox.EventsTarget, null, import_react345.default.createElement(
        PillsInput.Field,
        {
          ...rest,
          ref,
...
var TextInput = factory((props, ref) => {
  ...
  return import_react346.default.createElement(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  ...
  return import_react347.default.createElement(Box, { ref, ...getStyles2("root"), ...others });
});
...
var TimelineItem = factory((_props, ref) => {
  ...
  return import_react349.default.createElement(
    ...
    import_react349.default.createElement("div", { ...ctx.getStyles("itemBody", stylesApiProps) }, title && import_react349.default.createElement("div", { ...ctx.getStyles("itemTitle", stylesApiProps) }, title), import_react349.default.createElement("div", { ...ctx.getStyles("itemContent", stylesApiProps) }, children))
  );
});
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react350.Children.toArray(children);
  const items = _children.map(
    (item, index5) => {
      var _a, _b;
      return (0, import_react350.cloneElement)(item, {
        unstyled,
        __align: align,
  ...
  return import_react350.default.createElement(TimelineProvider, { value: { getStyles: getStyles2 } }, import_react350.default.createElement(Box, { ...getStyles2("root"), mod: { align }, ref, ...others }, items));
});
...
var varsResolver80 = createVarsResolver((_, { order, size: size4, lineClamp }) => {
...
var TypographyStylesProvider = factory((_props, ref) => {
  ...
  return import_react353.default.createElement(Box, { ref, ...getStyles2("root"), ...others });
});
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-QPXSGEOE.js.map
